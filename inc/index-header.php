...
<head>
    ...
    <title>Trinity Christian Church</title>
        ...
        <div class="container-2">
            ...
            <div class="collapse navbar-collapse navbar-main-collapse">
                <ul id="motor" class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll animsition-link" href="pages/Ministries.php">Ministries</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="page-scroll animsition-link" href="pages/MusicDept.php">Music Department</a>
                    </li>
                    <li>
