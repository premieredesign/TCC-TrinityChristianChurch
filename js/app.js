...
$('.masthead-video').coverVid(1600,1600);
...
$(document).ready(() => {
	...
	//Sermons Page=============================
	//=========================================
	$('.image-wrapper').find('img').hover(function(){$(this).append('.sermon-overlay')})
