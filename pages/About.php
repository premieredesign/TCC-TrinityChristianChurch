<?php include('../inc/about-header.php'); ?>
   ...
   <div class="jumbotron text-center">
    ...
    <!--<div class="jumbotron-1 text-center">
      <h1>In the Beginning...</h1>
    </div>-->
    <div class="photo-1">
      <h1 id="faith">Statement of Faith..</h1>
      <div class="we">
      <p><b class="orange-hover">We</b> believe the Bible to be the inspired, the only infallible authoritative Word of God. It is the ABSOLUTE truth.</p>
<p><b class="orange-hover">We</b> believe that there is one God, eternally existent in three persons: Father, Son and Holy Spirit.</p>
<p><b class="orange-hover">We</b> believe in the deity and humanity of Christ, in His virgin birth, in His sinless life, in His miracles, in his vicarious and atoning death through His shed blood, in His bodily resurrection, in His ascension to the right hand of the Father, in His present rule as Head of the Church and in His personal return in power and glory.</p>
<p><b class="orange-hover">We</b> believe that for salvation of lost and sinful men regeneration by the Holy Spirit is absolutely essential.</p>
<p><b class="orange-hover">We</b> believe in the present ministry of the Holy Spirit, by whose indwelling the Christian is enabled to live a godly life.</p>
<p><b class="orange-hover">We</b> believe in the resurrection of both the saved and the lost, they that are saved unto the resurrection of life and they that are lost unto the resurrection of damnation.
<p><b class="orange-hover">We</b> believe in the spiritual unity of believers in our Lord Jesus Christ, with equality across racial, gender, and class differences.</p>
</div>



<h1 id="doc">Statement of Doctrine</h1>

<p class="doc-p">The Scriptures
...
<h1 id="god-tri">God Is Triune</h1>

<p class="god-tri-p">There is one God: infinite, eternal, almighty, and perfect in holiness, truth, and love. In the unity of the godhead there are three persons, Father, Son and Holy Spirit, co-existent, co-equal, coeternal. One God - Father, Son and Holy Spirit - is the foundation of Christian faith and life.</p>

<h1 id="god-father">God the Father</h1>
